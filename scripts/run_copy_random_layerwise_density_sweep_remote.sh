...
LOG_DIR=logs/copy_corrected_q32_B64_d32_l8_log5_random_layerwise_density_sweep
mkdir -p "$LOG_DIR"

configs=(
  configs/copy_corrected_q32_B64_d32_l8_log5_random_layerwise_density10.json
  configs/copy_corrected_q32_B64_d32_l8_log5_random_layerwise_density30.json
  configs/copy_corrected_q32_B64_d32_l8_log5_random_layerwise_density50.json
  configs/copy_corrected_q32_B64_d32_l8_log5_random_layerwise_density70.json
  configs/copy_corrected_q32_B64_d32_l8_log5_random_layerwise_density90.json
)
...
"$PYTHON" scripts/summarize_copy_random_layerwise_density_sweep.py
